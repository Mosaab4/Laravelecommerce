                                    ...
                                    <tr class="cart_item">    
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img src="{{ asset($product->model->image) }}" alt="{{ $product->name }}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" style="max-width:80px;">
                                                </a>
                                        ...
                                        <td class="product-quantity">
                                            ...
                                            <div class="quantity">
                                                <a href="{{ route('cart.decreament',['id'=>$product->rowId, 'qty'=>$product->qty]) }}" class="quantity-minus">-</a>
                                                <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{ $product->qty }}">
                                                <a href="{{ route('cart.increament',['id'=>$product->rowId, 'qty'=>$product->qty]) }}" class="quantity-plus">+</a>
                                            </div>
